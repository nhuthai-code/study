'use client'; // Sử dụng client component để xử lý state cho tabs
...
const products = {
  "java-veloce": {
    ...
    image: "https://via.placeholder.com/600x400?text=JAVA+Veloce",
  },
  "java-siluro": {
    id: "java-siluro",
    ...
    image: "https://via.placeholder.com/600x400?text=JAVA+Siluro",
  },
  "trex-roadster": {
    id: "trex-roadster",
    ...
    image: "https://via.placeholder.com/600x400?text=TREX+Roadster",
  },
  "giant-propel": {
    id: "giant-propel",
    ...
    image: "https://via.placeholder.com/600x400?text=GIANT+Propel",
  },
};
...
export default async function ProductDetailPage({ params }) {
  ...
  // Component client để xử lý tabs
      ...
      <div className={styles.productTabs}>
        ...
        <div className={styles.tabContent}>
          ...
          >
            ...
            <p style={{ whiteSpace: "pre-line" }}>{product.technicalSpecs}</p>
          </div>
          <div
            id="geometry"
            className={`${styles.tab} ${
